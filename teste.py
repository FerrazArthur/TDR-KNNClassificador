...
conjunto_dados.reduzir_dimensionalidade(10)
...
# executar_multiplas_previsoes_correlacao_matriz_confusao(conjunto_dados, classificador=ClassificadorCorrelacao, tamanho_treino_lista=[32, 480], repeticoes=10, save_fig=True, fig_folder='resultados_correlacao')
