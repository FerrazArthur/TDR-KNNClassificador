...
from models.predict import run_multiple_tests, run_multiple_tests__train_explicit
from models.split_train_test import treino_media, treino_regular_explicit, treino_media_explicit
...
# run_multiple_tests__train_explicit([1], [15, 30], [treino_regular_explicit, treino_media_explicit], path='dados_2_cargas_2')