...
# conjunto_dados.imprime_classes(caminho=conjunto1_nome, save_fig=False, nome_arquivo="EXP_1_RESULT.pdf")
...
# Cargas_2_raw.imprime_classes(caminho="2_cargas_raw", lista_classes=["CA CA", "CA CC"], save_fig=True, nome_arquivo="EXP_2_1_2.pdf", frequencia=2)
# Cargas_2_raw.imprime_classes(caminho="2_cargas_raw", save_fig=True, nome_arquivo="EXP_2_CUT.pdf", inicio_plot=2*(10**-7), imprimir_medias=True, frequencia=2)

# Cargas_2_raw.imprime_classes(caminho="2_cargas_raw", lista_classes=["CA CA", "CC CA"], save_fig=True, nome_arquivo="EXP_2_2_1.pdf", frequencia=2)
# Cargas_2_raw.imprime_classes(caminho="2_cargas_raw", lista_classes=["CA CA", "CA CC", "CC CA"], save_fig=True, nome_arquivo="EXP_2_2_2_2-5.pdf", frequencia=2)
