...
# tamanho_treino_lista= [32]
# conjunto_dados = Dados(conjunto1_nome)
# resultdict = {}
# resultdict["KNN"] = executar_multiplas_previsoes_KNN_matriz_confusao(conjunto_dados, [1, 3], [32, 64], treinos_lista=[treino_regular, treino_media], repeticoes=1, save_fig=True, fig_folder=str(conjunto1_nome / knn_pasta))

# resultdict["CC"] = executar_multiplas_previsoes_correlacao_matriz_confusao(conjunto_dados, classificador=ClassificadorCorrelacao, tamanho_treino_lista=tamanho_treino_lista, repeticoes=1, save_fig=True, fig_folder=str(conjunto1_nome / corre_simples_pasta))
# print(resultdict)
# # resultdict["CA"] = executar_multiplas_previsoes_correlacao_matriz_confusao(conjunto_dados, classificador=ClassificadorCorrelacaoCruzada, tamanho_treino_lista=[32], repeticoes=1, save_fig=True, fig_folder=str(conjunto1_nome / corre_cruzada_pasta))
...
# resultdict_1["CS"] = executar_multiplas_previsoes_correlacao_matriz_confusao(conjunto_dados, classificador=ClassificadorCorrelacao, tamanho_treino_lista=[32, 64, 120, 240, 480], repeticoes=20, save_fig=True, fig_folder=str(conjunto1_nome / corre_simples_pasta))
# resultdict_1["CA"] = executar_multiplas_previsoes_correlacao_matriz_confusao(conjunto_dados, classificador=ClassificadorCorrelacaoCruzada, tamanho_treino_lista=[32, 64, 120, 240, 480], repeticoes=20, save_fig=True, fig_folder=str(conjunto1_nome / corre_cruzada_pasta))
# resultdict_1["kNN"] = executar_multiplas_previsoes_KNN_matriz_confusao(conjunto_dados, [1, 3, 5], [32, 64, 120, 240, 480], treinos_lista=[treino_regular, treino_media], repeticoes=20, save_fig=True, fig_folder=str(conjunto1_nome / knn_pasta))

# print(resultdict_1)
# # Salvar o dicionário em um arquivo
# with open('dict_1_500.pkl', 'wb') as f:
#     pickle.dump(resultdict_1, f)

# resultdict_2={}
# conjunto_dados = Dados(conjunto2_nome, base_codigo=8)
# conjunto_dados.reduzir_dimensionalidade(extended_slices=2)
# resultdict_2["CS"] = executar_multiplas_previsoes_correlacao_matriz_confusao(conjunto_dados, classificador=ClassificadorCorrelacao, tamanho_treino_lista=[630, 1050, 1260, 1470, 1932], repeticoes=20, save_fig=True, fig_folder=str(conjunto2_nome / corre_simples_pasta))
# resultdict_2["CA"] = executar_multiplas_previsoes_correlacao_matriz_confusao(conjunto_dados, classificador=ClassificadorCorrelacaoCruzada, tamanho_treino_lista=[630, 1050, 1260, 1470, 1932], repeticoes=20, save_fig=True, fig_folder=str(conjunto2_nome / corre_cruzada_pasta))
# resultdict_2["kNN"] = executar_multiplas_previsoes_KNN_matriz_confusao(conjunto_dados, [1, 3, 5], [630, 1050, 1260, 1470, 1932], treinos_lista=[treino_regular, treino_media], repeticoes=20, save_fig=True, fig_folder=str(conjunto2_nome / knn_pasta))


# print(resultdict_2)
# # Salvar o dicionário em um arquivo
# with open('dict_2_500.pkl', 'wb') as f:
...
# imprima a quantidade de colunas no novo conjunto de dados
...
# # conjunto_dados.reduzir_dimensionalidade(extended_slices=2)
# conjunto_dados.imprime_classes(caminho=conjunto2_nome, save_fig=True, nome_arquivo="EXP_2_RESULT.pdf", frequencia=2)
# conjunto_dados.imprime_classes(caminho=conjunto2_nome, save_fig=True, nome_arquivo="EXP_2_MEANS.pdf", imprimir_medias=True, frequencia=2)
...
# Cargas_1_raw.imprime_classes(caminho="1_carga_raw", save_fig=False, nome_arquivo="EXP_1_RESULT.pdf")
...
# Cargas_1_raw.imprime_classes(caminho="1_carga_raw", save_fig=True, nome_arquivo="EXP_1_CUT.pdf", inicio_plot=0.9*(10**-7))

# Cargas_2_raw = Dados("2_cargas_raw", base_codigo=8)
# Cargas_2_raw.imprime_classes(caminho="2_cargas_raw", save_fig=True, nome_arquivo="EXP_2_RESULT.pdf", frequencia=2)
# Cargas_2_raw.imprime_classes(caminho="2_cargas_raw", lista_classes=["CA CA", "CA CC", "CC CA"], save_fig=True, nome_arquivo="EXP_2_2_2.pdf", frequencia=2)
